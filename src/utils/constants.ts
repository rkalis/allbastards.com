...
export const RARIBLE_BASE = (process.env.REACT_APP_ETHEREUM_NETWORK !== 'rinkeby' ? 'https://rarible.com/token/0x31385d3520bced94f77aae104b406994d8f2168c' : 'https://rinkeby.rarible.com/token/0xf48ce8E434667b02cA98966cc78794151A653419');
export const OPENSEA_BASE = (process.env.REACT_APP_ETHEREUM_NETWORK !== 'rinkeby' ? 'https://opensea.io/assets/0x31385d3520bced94f77aae104b406994d8f2168c' : 'https://rinkeby.opensea.io/assets/0xf48ce8E434667b02cA98966cc78794151A653419');
...
export const BASTARD_CONTRACT_ADDRESS = (process.env.REACT_APP_ETHEREUM_NETWORK !== 'rinkeby' ? '0x31385d3520bCED94f77AaE104b406994D8F2168C' : '0xf48ce8E434667b02cA98966cc78794151A653419');
...
export const WETH_ADDRESS = (process.env.REACT_APP_ETHEREUM_NETWORK !== 'rinkeby' ? '0xC02aaA39b223FE8D0A0e5C4F27eAD9083C756Cc2' : '0xc778417E063141139Fce010982780140Aa0cD5Ab');
