    ...
    <Transition.Root show={isOpen} as={Fragment}>
      ...
      >
        <div className="flex items-end justify-center min-h-screen px-4 text-center sm:block">
          ...
          >
            <div className="inline-block align-bottom bg-white border-2 border-black text-left overflow-visible shadow-xl transform transition-all sm:align-middle sm:max-w-lg sm:w-full">
